...
class DenseCursor(Cursor):
    ...
    def offset(self, src_block: Coords, dest_block: Coords, dest_cell: Coords) -> int:
    ...
    def move(
        self, src: CursorLocation, dest_block: Coords
    ...
    def look(
        self, src: CursorLocation, dest_block: Coords, dest_cell: Coords
        ...
        addr = pypspamm.architecture.operands.mem(self.base_ptr, rel_offset)

...
class MatMul:
    def __init__(self,
        ...
        pypspamm.architecture.Generator = pypspamm.architecture.get_class("pypspamm.codegen.architectures." + arch + ".generator").Generator
        pypspamm.architecture.operands = pypspamm.architecture.get_class("pypspamm.codegen.architectures." + arch + ".operands")
        pypspamm.architecture.blocksize = pypspamm.architecture.get_class("pypspamm.codegen.architectures." + arch + ".blocksize").Default
        ...
        if bm == None or bn == None:
            (self.bm, self.bn, self.bk) = pypspamm.architecture.blocksize.getBlocksize(m, n, bk, self.v_size, self.precision)
        else: 
            self.bm = bm
            self.bn = bn
            self.bk = bk

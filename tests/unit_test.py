...
kernels.append(DenseKernel("test2", 8, 40, 40, 8, 40, 8, 1, [(8, 5), (8,2)], 0.0000001))
...
if arch == "knl":
	...
	knl_kernels.append(SparseKernel("knl_only_test4", 8, 20, 10, 40, 0, 8, 0, [(8, 20), (8,3)], "/home/hpc/pr63so/ga96voz2/example_matrix.mtx", 0.0000001))
